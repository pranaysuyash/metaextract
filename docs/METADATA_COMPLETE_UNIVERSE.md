...
**Note**: This document is media-only. For the all-domain comprehensive field inventory (documents, scientific, forensic, web/social), see `METADATA_ULTIMATE_UNIVERSE.md`.
