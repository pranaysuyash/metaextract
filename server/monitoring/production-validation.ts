...
export class ThreatIntelligenceService {
  ...
  private async checkAbuseIPDB(ipAddress: string): Promise<any> {
    ...
    try {
      ...
      console.warn(`[ThreatIntel] AbuseIPDB check failed for ${ipAddress}:`, error.message);
      return null;
    }
  }
  ...
  private async checkVirusTotal(ipAddress: string): Promise<any> {
    ...
    try {
      ...
      console.warn(`[ThreatIntel] VirusTotal check failed for ${ipAddress}:`, error.message);
      return null;
    }
  }
  ...
  private async checkIPQuality(ipAddress: string): Promise<any> {
    ...
    try {
      ...
      console.warn(`[ThreatIntel] IPQuality check failed for ${ipAddress}:`, error.message);
      return null;
    }
  }
  ...
  private async checkTorExit(ipAddress: string): Promise<boolean> {
    ...
    try {
      ...
      console.warn(`[ThreatIntel] TOR check failed for ${ipAddress}:`, error.message);
      return false;
    }
  }
  ...
  private async checkVPNProxy(ipAddress: string): Promise<boolean> {
    ...
    try {
      ...
      console.warn(`[ThreatIntel] VPN check failed for ${ipAddress}:`, error.message);
      return false;
    }
  }
