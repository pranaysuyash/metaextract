...
def extract_ergonomics_assessment(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xlviii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xlviii(file_path)

def get_ergonomics_assessment_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_field_count()

def get_ergonomics_assessment_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_version()

def get_ergonomics_assessment_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_description()

def get_ergonomics_assessment_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_supported_formats()

def get_ergonomics_assessment_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xlviii_modalities()
