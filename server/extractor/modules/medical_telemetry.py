...
def extract_medical_telemetry(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxxv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxxv(file_path)

def get_medical_telemetry_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_field_count()

def get_medical_telemetry_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_version()

def get_medical_telemetry_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_description()

def get_medical_telemetry_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_supported_formats()

def get_medical_telemetry_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxv_modalities()
