...
def extract_obstetrics_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xv(file_path)

def get_obstetrics_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xv_field_count()

def get_obstetrics_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xv_version()

def get_obstetrics_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xv_description()

def get_obstetrics_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xv_supported_formats()

def get_obstetrics_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xv_modalities()
