...
def extract_nmr_spectroscopy(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxxiii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxxiii(file_path)

def get_nmr_spectroscopy_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_field_count()

def get_nmr_spectroscopy_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_version()

def get_nmr_spectroscopy_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_description()

def get_nmr_spectroscopy_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_supported_formats()

def get_nmr_spectroscopy_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiii_modalities()
