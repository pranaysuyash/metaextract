...
def extract_environmental_health(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xcv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xcv(file_path)

def get_environmental_health_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcv_field_count()

def get_environmental_health_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcv_version()

def get_environmental_health_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcv_description()

def get_environmental_health_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcv_supported_formats()

def get_environmental_health_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcv_modalities()
