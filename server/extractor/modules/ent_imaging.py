...
def extract_ent_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xii(file_path)

def get_ent_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xii_field_count()

def get_ent_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xii_version()

def get_ent_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xii_description()

def get_ent_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xii_supported_formats()

def get_ent_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xii_modalities()
