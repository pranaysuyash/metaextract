...
def extract_cardiology_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxiii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxiii(file_path)

def get_cardiology_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_field_count()

def get_cardiology_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_version()

def get_cardiology_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_description()

def get_cardiology_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_supported_formats()

def get_cardiology_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxiii_modalities()
