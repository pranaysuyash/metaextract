...
def extract_medical_logging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxix."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxix(file_path)

def get_medical_logging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_field_count()

def get_medical_logging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_version()

def get_medical_logging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_description()

def get_medical_logging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_supported_formats()

def get_medical_logging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxix_modalities()
