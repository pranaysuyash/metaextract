...
def extract_medical_alerts(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii(file_path)

def get_medical_alerts_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_field_count()

def get_medical_alerts_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_version()

def get_medical_alerts_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_description()

def get_medical_alerts_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_supported_formats()

def get_medical_alerts_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxviii_modalities()
