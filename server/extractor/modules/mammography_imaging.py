...
def extract_mammography_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_iv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_iv(file_path)

def get_mammography_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_iv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_iv_field_count()

def get_mammography_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_iv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_iv_version()

def get_mammography_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_iv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_iv_description()

def get_mammography_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_iv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_iv_supported_formats()

def get_mammography_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_iv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_iv_modalities()
