...
def extract_pathology_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxviii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxviii(file_path)

def get_pathology_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_field_count()

def get_pathology_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_version()

def get_pathology_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_description()

def get_pathology_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_supported_formats()

def get_pathology_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxviii_modalities()
