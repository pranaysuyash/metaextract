...
def extract_home_health(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lx."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lx(file_path)

def get_home_health_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lx_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lx_field_count()

def get_home_health_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lx_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lx_version()

def get_home_health_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lx_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lx_description()

def get_home_health_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lx_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lx_supported_formats()

def get_home_health_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lx_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lx_modalities()
