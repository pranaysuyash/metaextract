...
def extract_industrial_medicine(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xcvii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xcvii(file_path)

def get_industrial_medicine_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_field_count()

def get_industrial_medicine_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_version()

def get_industrial_medicine_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_description()

def get_industrial_medicine_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_supported_formats()

def get_industrial_medicine_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xcvii_modalities()
