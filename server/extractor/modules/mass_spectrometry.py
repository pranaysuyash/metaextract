...
def extract_mass_spectrometry(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxxii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxxii(file_path)

def get_mass_spectrometry_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_field_count()

def get_mass_spectrometry_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_version()

def get_mass_spectrometry_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_description()

def get_mass_spectrometry_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_supported_formats()

def get_mass_spectrometry_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxii_modalities()
