...
def extract_radiology_advanced(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxvii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxvii(file_path)

def get_radiology_advanced_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_field_count()

def get_radiology_advanced_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_version()

def get_radiology_advanced_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_description()

def get_radiology_advanced_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_supported_formats()

def get_radiology_advanced_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxvii_modalities()
