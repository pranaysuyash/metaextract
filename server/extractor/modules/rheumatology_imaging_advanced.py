"""
Advanced Rheumatology Imaging Metadata Extraction
...
Renamed from: scientific_extension_73.py (Scientific DICOM/FITS Extension LXXIII)
...
RHEUMATOLOGY_IMAGING_ADVANCED_AVAILABLE = True
...
def extract_scientific_extension_73(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxiii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxiii(file_path)

def get_scientific_extension_73_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_field_count()

def get_scientific_extension_73_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_version()

def get_scientific_extension_73_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_description()

def get_scientific_extension_73_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_supported_formats()

def get_scientific_extension_73_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiii_modalities()
...
def extract_rheumatology_imaging_advanced(file_path: str) -> Dict[str, Any]:
    """Extract advanced rheumatology imaging metadata from DICOM files."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxiii(file_path)


def get_rheumatology_imaging_advanced_field_count() -> int:
    """Get the total number of rheumatology imaging metadata fields supported."""
    return len(TOTAL_TAGS_LXXIII)


def get_rheumatology_imaging_advanced_version() -> str:
    """Get the version of this module."""
    return "2.0.0"


def get_rheumatology_imaging_advanced_description() -> str:
    """Get the description of this module."""
    return ("Rheumatology imaging metadata extraction. Supports inflammatory arthritis, "
            "connective tissue diseases, autoimmune disorders, and rheumatology-specific "
            "imaging protocols for comprehensive rheumatologic analysis.")


def get_rheumatology_imaging_advanced_modalities() -> List[str]:
    """Get supported imaging modalities."""
    return ["MR", "US", "CR", "DX", "CT"]


def get_rheumatology_imaging_advanced_supported_formats() -> List[str]:
    """Get supported file formats."""
    return [".dcm", ".dicom"]


def get_rheumatology_imaging_advanced_category() -> str:
    """Get the category of this imaging module."""
    return "Rheumatology Imaging"


def get_rheumatology_imaging_advanced_keywords() -> List[str]:
    """Get keywords associated with this module."""
    return [
        "rheumatology", "arthritis", "SLE", "lupus", "scleroderma",
        "vasculitis", "myositis", "spondyloarthritis", "autoimmune", "inflammatory"
    ]
