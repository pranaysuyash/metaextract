...
def extract_microscopy_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxix."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxix(file_path)

def get_microscopy_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxix_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxix_field_count()

def get_microscopy_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxix_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxix_version()

def get_microscopy_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxix_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxix_description()

def get_microscopy_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxix_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxix_supported_formats()

def get_microscopy_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxix_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxix_modalities()
