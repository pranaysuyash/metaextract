...
def extract_hospice_care(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lix."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lix(file_path)

def get_hospice_care_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lix_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lix_field_count()

def get_hospice_care_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lix_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lix_version()

def get_hospice_care_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lix_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lix_description()

def get_hospice_care_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lix_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lix_supported_formats()

def get_hospice_care_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lix_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lix_modalities()
