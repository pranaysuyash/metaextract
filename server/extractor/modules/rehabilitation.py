...
def extract_rehabilitation(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_l."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_l(file_path)

def get_rehabilitation_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_l_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_l_field_count()

def get_rehabilitation_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_l_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_l_version()

def get_rehabilitation_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_l_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_l_description()

def get_rehabilitation_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_l_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_l_supported_formats()

def get_rehabilitation_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_l_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_l_modalities()
