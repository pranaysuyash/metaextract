...
def extract_angiography_ct(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_x."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_x(file_path)

def get_angiography_ct_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_x_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_x_field_count()

def get_angiography_ct_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_x_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_x_version()

def get_angiography_ct_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_x_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_x_description()

def get_angiography_ct_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_x_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_x_supported_formats()

def get_angiography_ct_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_x_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_x_modalities()
