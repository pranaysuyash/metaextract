...
def extract_pdf_office_ext_2(file_path):
    """Alias for extract_pdf_office_ultimate_advanced_extension_ii_metadata."""
    return extract_pdf_office_ultimate_advanced_extension_ii_metadata(file_path)

def get_pdf_office_ext_2_field_count():
    """Alias for get_pdf_office_ultimate_advanced_extension_ii_field_count."""
    return get_pdf_office_ultimate_advanced_extension_ii_field_count()

def get_pdf_office_ext_2_version():
    """Alias for get_pdf_office_ultimate_advanced_extension_ii_version."""
    return get_pdf_office_ultimate_advanced_extension_ii_version()

def get_pdf_office_ext_2_description():
    """Alias for get_pdf_office_ultimate_advanced_extension_ii_description."""
    return get_pdf_office_ultimate_advanced_extension_ii_description()

def get_pdf_office_ext_2_supported_formats():
    """Alias for get_pdf_office_ultimate_advanced_extension_ii_supported_formats."""
    return get_pdf_office_ultimate_advanced_extension_ii_supported_formats()

def get_pdf_office_ext_2_modalities():
    """Alias for get_pdf_office_ultimate_advanced_extension_ii_modalities."""
    return get_pdf_office_ultimate_advanced_extension_ii_modalities()
