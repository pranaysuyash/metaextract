...
def extract_chromatography(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxxvi."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxxvi(file_path)

def get_chromatography_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_field_count()

def get_chromatography_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_version()

def get_chromatography_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_description()

def get_chromatography_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_supported_formats()

def get_chromatography_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxvi_modalities()
