...
def extract_musculoskeletal_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_vii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_vii(file_path)

def get_musculoskeletal_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vii_field_count()

def get_musculoskeletal_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vii_version()

def get_musculoskeletal_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vii_description()

def get_musculoskeletal_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vii_supported_formats()

def get_musculoskeletal_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vii_modalities()
