...
def extract_pediatric_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_vi."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_vi(file_path)

def get_pediatric_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vi_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vi_field_count()

def get_pediatric_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vi_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vi_version()

def get_pediatric_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vi_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vi_description()

def get_pediatric_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vi_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vi_supported_formats()

def get_pediatric_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_vi_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_vi_modalities()
