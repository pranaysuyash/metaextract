...
def extract_paleontology_imaging(file_path: str) -> Dict[str, Any]:
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xliv(file_path)

def get_paleontology_imaging_field_count() -> int:
    return get_scientific_dicom_fits_ultimate_advanced_extension_xliv_field_count()

def get_paleontology_imaging_version() -> str:
    return get_scientific_dicom_fits_ultimate_advanced_extension_xliv_version()

def get_paleontology_imaging_description() -> str:
    return get_scientific_dicom_fits_ultimate_advanced_extension_xliv_description()

def get_paleontology_imaging_supported_formats() -> List[str]:
    return get_scientific_dicom_fits_ultimate_advanced_extension_xliv_supported_formats()

def get_paleontology_imaging_modalities() -> List[str]:
    return get_scientific_dicom_fits_ultimate_advanced_extension_xliv_modalities()

def get_paleontology_imaging_category() -> str:
    return get_scientific_dicom_fits_ultimate_advanced_extension_xliv_category()

def get_paleontology_imaging_keywords() -> List[str]:
    return get_scientific_dicom_fits_ultimate_advanced_extension_xliv_keywords()
