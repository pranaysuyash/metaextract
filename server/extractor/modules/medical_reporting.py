...
def extract_medical_reporting(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxxi."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxxi(file_path)

def get_medical_reporting_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_field_count()

def get_medical_reporting_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_version()

def get_medical_reporting_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_description()

def get_medical_reporting_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_supported_formats()

def get_medical_reporting_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxxi_modalities()
