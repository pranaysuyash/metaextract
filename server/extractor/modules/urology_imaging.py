...
def extract_urology_imaging(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xiii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xiii(file_path)

def get_urology_imaging_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xiii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xiii_field_count()

def get_urology_imaging_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xiii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xiii_version()

def get_urology_imaging_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xiii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xiii_description()

def get_urology_imaging_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xiii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xiii_supported_formats()

def get_urology_imaging_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xiii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xiii_modalities()
