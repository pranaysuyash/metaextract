...
def extract_crystallography(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxxiv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxxiv(file_path)

def get_crystallography_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_field_count()

def get_crystallography_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_version()

def get_crystallography_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_description()

def get_crystallography_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_supported_formats()

def get_crystallography_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxiv_modalities()
