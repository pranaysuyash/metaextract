...
def extract_pcr_analysis(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xxxi."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xxxi(file_path)

def get_pcr_analysis_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_field_count()

def get_pcr_analysis_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_version()

def get_pcr_analysis_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_description()

def get_pcr_analysis_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_supported_formats()

def get_pcr_analysis_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xxxi_modalities()
