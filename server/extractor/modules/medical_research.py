...
def extract_medical_research(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xci."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xci(file_path)

def get_medical_research_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xci_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xci_field_count()

def get_medical_research_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xci_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xci_version()

def get_medical_research_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xci_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xci_description()

def get_medical_research_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xci_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xci_supported_formats()

def get_medical_research_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xci_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xci_modalities()
