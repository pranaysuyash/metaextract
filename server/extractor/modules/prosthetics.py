...
def extract_prosthetics(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_liii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_liii(file_path)

def get_prosthetics_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_liii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_liii_field_count()

def get_prosthetics_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_liii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_liii_version()

def get_prosthetics_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_liii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_liii_description()

def get_prosthetics_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_liii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_liii_supported_formats()

def get_prosthetics_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_liii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_liii_modalities()
