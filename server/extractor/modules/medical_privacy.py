...
def extract_medical_privacy(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxv(file_path)

def get_medical_privacy_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_field_count()

def get_medical_privacy_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_version()

def get_medical_privacy_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_description()

def get_medical_privacy_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_supported_formats()

def get_medical_privacy_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxv_modalities()
