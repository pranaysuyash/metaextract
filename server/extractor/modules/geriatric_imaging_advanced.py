"""
Advanced Geriatric Imaging Metadata Extraction
...
Renamed from: scientific_extension_77.py (Scientific DICOM/FITS Extension LXXVII)
...
GERIATRIC_IMAGING_ADVANCED_AVAILABLE = True
...
GERIATRIC_TOTAL_TAGS = TOTAL_TAGS_LXXVII
...
def extract_scientific_extension_77(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxvii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxvii(file_path)

def get_scientific_extension_77_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_field_count()

def get_scientific_extension_77_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_version()

def get_scientific_extension_77_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_description()

def get_scientific_extension_77_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_supported_formats()

def get_scientific_extension_77_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxvii_modalities()
...
def extract_geriatric_imaging_advanced(file_path: str) -> Dict[str, Any]:
    """Extract advanced geriatric imaging metadata from DICOM files."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxvii(file_path)


def get_geriatric_imaging_advanced_field_count() -> int:
    """Get the total number of geriatric imaging metadata fields supported."""
    return len(GERIATRIC_TOTAL_TAGS)


def get_geriatric_imaging_advanced_version() -> str:
    """Get the version of this module."""
    return "2.0.0"


def get_geriatric_imaging_advanced_description() -> str:
    """Get the description of this module."""
    return ("Geriatric imaging metadata extraction. Supports age-related conditions, "
            "frailty assessment, polypharmacy considerations, and elderly-specific "
            "imaging protocols for comprehensive geriatric analysis.")


def get_geriatric_imaging_advanced_modalities() -> List[str]:
    """Get supported imaging modalities."""
    return ["CT", "MR", "CR", "DX", "US", "NM"]


def get_geriatric_imaging_advanced_supported_formats() -> List[str]:
    """Get supported file formats."""
    return [".dcm", ".dicom"]


def get_geriatric_imaging_advanced_category() -> str:
    """Get the category of this imaging module."""
    return "Geriatric Imaging"


def get_geriatric_imaging_advanced_keywords() -> List[str]:
    """Get keywords associated with this module."""
    return [
        "geriatric", "elderly", "frailty", "polypharmacy", "dementia",
        "falls", "osteoporosis", "cognitive", "functional status", "aging"
    ]
