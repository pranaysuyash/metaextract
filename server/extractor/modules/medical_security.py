...
def extract_medical_security(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxiv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxiv(file_path)

def get_medical_security_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_field_count()

def get_medical_security_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_version()

def get_medical_security_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_description()

def get_medical_security_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_supported_formats()

def get_medical_security_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxiv_modalities()
