...
APPLE_MAKERNOTE_TAGS = {
    ...
    # Modern Computational Photography (2020-2024)
    "Apple_DeepFusion": "apple_deep_fusion",
    "Apple_NightMode": "apple_night_mode",
    "Apple_NightModeDuration": "apple_night_mode_duration",
    "Apple_SmartHDR_Version": "apple_smart_hdr_version",
    "Apple_ProRAW_Processing": "apple_pro_raw_processing",
    "Apple_PortraitLightingEffect": "apple_portrait_lighting_effect",
    "Apple_DepthDataVersion": "apple_depth_data_version",
    "Apple_BokehShape": "apple_bokeh_shape",
    "Apple_CinematicModeFPS": "apple_cinematic_mode_fps",
    "Apple_CinematicModeFocusPoints": "apple_cinematic_mode_focus_points",
    "Apple_CinematicModeAperture": "apple_cinematic_mode_aperture",
    "Apple_MovieMode": "apple_movie_mode",
    "Apple_ActionMode": "apple_action_mode",
    "Apple_MacroMode": "apple_macro_mode",
    "Apple_PhotographicStyles": "apple_photographic_styles",
    "Apple_PhotographicStyleTone": "apple_photographic_style_tone",
    "Apple_PhotographicStyleWarmth": "apple_photographic_style_warmth",
    "Apple_LidarDepthData": "apple_lidar_depth_data",
    "Apple_LidarScannerAvailable": "apple_lidar_scanner_available",
    "Apple_ProResRAW": "apple_prores_raw",
    "Apple_LogProfile": "apple_log_profile",
...
ANDROID_TAGS = {
    ...
    # Modern Google Pixel Computational Photography (2020-2024)
    "Google_Astrophotography": "google_astrophotography",
    "Google_RealTone": "google_real_tone",
    "Google_FaceUnblur": "google_face_unblur",
    "Google_MotionMode": "google_motion_mode",
    "Google_TopShot_Version": "google_top_shot_version",
    "Google_CinematicPhotos": "google_cinematic_photos",
    "Google_HDR_Plus_Version": "google_hdr_plus_version",
    "Google_MultiFrameProcessing": "google_multi_frame_processing",
    "Google_SuperResolution": "google_super_resolution",
    "Google_DeepZoom": "google_deep_zoom",
    "Google_AI_SceneDetection": "google_ai_scene_detection",
    "Google_NightSight_Version": "google_night_sight_version",
    "Google_PortraitMode_Version": "google_portrait_mode_version",
    "Google_ComputationalRaw": "google_computational_raw",
...
SAMSUNG_TAGS = {
    ...
    # Modern Samsung Computational Photography (2020-2024)
    "Samsung_NightMode": "samsung_night_mode",
    "Samsung_SingleTake": "samsung_single_take",
    "Samsung_FoodMode": "samsung_food_mode",
    "Samsung_Panorama": "samsung_panorama",
    "Samsung_MacroMode": "samsung_macro_mode",
    "Samsung_DirectorsView": "samsung_directors_view",
    "Samsung_AI_SceneOptimizer": "samsung_ai_scene_optimizer",
    "Samsung_FlawDetection": "samsung_flaw_detection",
    "Samsung_BestFace": "samsung_best_face",
    "Samsung_EraserMode": "samsung_eraser_mode",
    "Samsung_SelectiveFocus": "samsung_selective_focus",
    "Samsung_VirtualShot": "samsung_virtual_shot",
    "Samsung_SuperSlowMotion": "samsung_super_slow_motion",
    "Samsung_Hyperlapse": "samsung_hyperlapse",
    "Samsung_ProMode": "samsung_pro_mode",
    "Samsung_RAWSupport": "samsung_raw_support",
}
