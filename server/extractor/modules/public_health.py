...
def extract_public_health(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_xciv."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_xciv(file_path)

def get_public_health_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xciv_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xciv_field_count()

def get_public_health_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xciv_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xciv_version()

def get_public_health_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xciv_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xciv_description()

def get_public_health_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xciv_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xciv_supported_formats()

def get_public_health_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_xciv_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_xciv_modalities()
