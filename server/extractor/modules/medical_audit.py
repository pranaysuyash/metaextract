...
def extract_medical_audit(file_path):
    """Alias for extract_scientific_dicom_fits_ultimate_advanced_extension_lxxviii."""
    return extract_scientific_dicom_fits_ultimate_advanced_extension_lxxviii(file_path)

def get_medical_audit_field_count():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_field_count."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_field_count()

def get_medical_audit_version():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_version."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_version()

def get_medical_audit_description():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_description."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_description()

def get_medical_audit_supported_formats():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_supported_formats."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_supported_formats()

def get_medical_audit_modalities():
    """Alias for get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_modalities."""
    return get_scientific_dicom_fits_ultimate_advanced_extension_lxxviii_modalities()
