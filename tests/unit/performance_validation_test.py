...
from server.extractor.advanced_optimizations import SmartCacheManager
from server.extractor.advanced_optimizations import create_optimized_config, PerformancePredictor
