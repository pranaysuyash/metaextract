...
def test_endpoint(endpoint, method="GET", files=None, data=None, params=None, expected_status=200, name=""):
...
def main():
    ...
    success, response = test_endpoint("/api/health", name="Main Health")
    results.append(("Main Health", success))
    
    success, response = test_endpoint("/api/extract/health", name="Extract Health")
    results.append(("Extract Health", success))
    
    success, response = test_endpoint("/api/extract/health/image", name="Image Health")
    ...
    with open(test_image, 'rb') as f:
        ...
        success, response = test_endpoint("/api/extract", method="POST", files=files, 
    ...
    with open(test_image, 'rb') as f:
        files = {'file': ('test.jpg', f, 'image/jpeg')}
        success, response = test_endpoint("/api/extract/advanced", method="POST", files=files,
    ...
    success, response = test_endpoint("/api/timeline/reconstruct", method="POST", files=files,
    ...
    with open(test_image, 'rb') as f:
        files = {'file': ('test.jpg', f, 'image/jpeg')}
        success, response = test_endpoint("/api/images_mvp/extract", method="POST", files=files,
    ...
    # Credit packs
    success, response = test_endpoint("/api/images_mvp/credits/packs", name="Credit Packs")
    ...
    success, response = test_endpoint("/api/forensic/capabilities", params={'tier': 'enterprise'}, 
