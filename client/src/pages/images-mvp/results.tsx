        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-4xl">
          ...
          {!canExport && (
            <p className="text-xs text-slate-500 mb-6">
              JSON export is available after the trial. Summary export stays
              available.
            </p>
          )}
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-200 text-xs leading-relaxed">
                  You are viewing a limited trial report. Raw IPTC and XMP data
                  has been summarized or redacted. Unlock credits to view the
                  full report and raw exports.
                </p>
              </div>
                  ...
                  <CardContent>
                    {!canExport && (
                      <div className="text-sm text-slate-200 mb-4">
                        Raw JSON export is locked during the trial, but you can
