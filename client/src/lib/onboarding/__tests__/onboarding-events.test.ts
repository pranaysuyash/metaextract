...
import type { OnboardingEvent } from '@/lib/onboarding/onboarding-engine';
...
describe('OnboardingEventBus', () => {
  ...
  describe('event history', () => {
    ...
    it('should filter history by type', () => {
      ...
      const stepEvents = bus.getHistoryByType('step:completed') as Array<
        Extract<OnboardingEvent, { type: 'step:completed' }>
      >;
