...
const buttonVariants = cva(
  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ' +
    ...
    // Mobile-friendly touch targets (44px minimum for touch devices)
    'md:min-h-9 min-h-[44px]',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: 'md:min-h-9 min-h-[44px] px-4 py-2',
        sm: 'md:min-h-8 min-h-[40px] rounded-md px-3 text-xs',
        lg: 'md:min-h-10 min-h-[48px] rounded-md px-8',
